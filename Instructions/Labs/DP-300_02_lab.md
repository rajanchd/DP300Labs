...
9. Confirm the endpoint appears on the Networking page. 
‎
	![Picture 22](../images/dp-3300-module-22-lab-17.png)

10. Click the **Next: Security** button. Leave the default _Enable Azure Defender for SQL_ **Not Now**. Then click the **Next: Additional settings** button.  

11. On the Additional Settings page, select the following options:
...
14. Once the deployment is complete, click the **Go to resource** button  
‎

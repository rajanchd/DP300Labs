...
3. Configure the virtual network’s IP range for the Azure SQL database endpoint
	...
	- Click on the **default** subnet. (Note that the IP address you see might be different.)  
‎
...
3. In the Connection Details sidebar, enter the following information to connect to the previous Task’s PostgreSQL database:
	...
	- User name: **dp300admin@dp300-lab02-doc** (note that the user name must include the hostname that you specified above; use your suffix instread of 'doc') 

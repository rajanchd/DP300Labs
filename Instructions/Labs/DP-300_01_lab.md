...
7. On the Resource groups blade, select the Add button. 

	![Picture 11](../images/dp-3300-module-11-lab-07.png)

 
8. Ensure you have selected the appropriate subscription for the lab. Name the resource group DP-300-Lab01. Select the nearest Azure region to your location Select the Review + Create button. Then select the Create button. 
...
1. On the Azure SQL blade, select the New button. 

	![Picture 8]![image](https://user-images.githubusercontent.com/16070952/110152179-64462700-7daf-11eb-8b83-43e7e0fcc041.png)
...
Exit out of the Remote Desktop. 

Remove the VM you created in this lab to save costs. You will not be using it for subsequent labs. 

Navigate to the main (Overview) blade for the **dp300sqlvmlab01** Virtual Machine and click the delete button in the menu. 

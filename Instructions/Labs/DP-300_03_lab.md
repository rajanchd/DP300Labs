...
1. Navigate to the Azure Portal, and click on your user name in the top right corner of the screen.
	...
	**Note:** A Microsoft account (a user account from Outlook, Gmail, Hotmail or Yahoo, for example) is not supported for the Azure Active Directory administrator for Azure SQL Database. As a workaround, you can create an Azure Active Directory group named DBA and add your user account to it. Alternatively, you can skip Task 2.”
